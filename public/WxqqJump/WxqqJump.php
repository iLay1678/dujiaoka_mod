...
$siteurl=$http_type.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];

if((strpos($_SERVER['HTTP_USER_AGENT'], 'QQ/')||strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger'))!==false
    
    && (strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone')||strpos($_SERVER['HTTP_USER_AGENT'], 'iPad'))!==false
    
    && strpos($_SERVER['REQUEST_URI'],  strval("buy"))!==false
